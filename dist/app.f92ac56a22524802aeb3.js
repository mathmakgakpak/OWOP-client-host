            ...
            function(e) {
                ...
                if (e & m.rendertype.FX && null !== a.misc.world) {
                    ...
                    var R = a.misc.world.players
                      , z = .625 * i | 0;
                    for (var O in p.currentFontSize != z && (h.font = z + "px sans-serif",
                    p.currentFontSize = z),
                    R)
                        ...
                        !function(t, n) {
                            ...
                            a.absMod)(n, i.protocol.chunkSize) + r.height) / i.protocol.chunkSize)
                              , d = function(e, o) {
                                var i = o - n
                                  , a = e - t;
                                if (i < 0 || a < 0 || i >= r.height || a >= r.width) {
                                    var l = h.misc.world.getPixel(e, o);
                                    return l ? l[2] << 16 | l[1] << 8 | l[0] : null
                                }
                                var c = s[i * r.width + a]
                                  , u = h.misc.world.getPixel(e, o)
                                  , d = c >> 24 & 255;
                                if (!u)
                                    return null;
                                var f = (1 - d / 255) * u[0] + d / 255 * (255 & c)
                                  , p = (1 - d / 255) * u[1] + d / 255 * (c >> 8 & 255)
                                  , m = (1 - d / 255) * u[2] + d / 255 * (c >> 16 & 255)
                                  , v = m << 16 | p << 8 | f;
                                return f == u[0] && p == u[1] && m == u[2] ? v : 4278190080 | v
                            }
                              , f = function(e, t) {
    ...
    t.World = function() {
        ...
        return o(e, [{
            ...
            value: function(e, t, n, o) {
                ...
                if (f && (!f.locked || u.player.rank >= r.RANK.MODERATOR)) {
        ...
        i(t, [{
            ...
            value: function(e, t, n, o) {
                ...
                if (this.isConnected() && (a < 3 || p.player.rank == l.RANK.ADMIN) && this.placeBucket.canSpend(1)) {
                    ...
                    c.setUint8(10, n[2]),
                    this.ws.send(s),
                    this.pendingEdits[e + "," + t] = setTimeout(o, 2e3),
                    !0
                }
                return !1
            }
